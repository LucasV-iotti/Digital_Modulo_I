  ...
  nodes:{
    abordagem_inicio_pf:{
      ...
      options:[
        ...
        { text:'Vou pular direto para a proposta e você me dá o seu ok.', next:', next:'oferta_negociacao', effects:{empatia:0,resolucao:+1,tempo:+1,satisf:+1}, tag:'ok' },
    ...
    oferta_negociacao:{
      ...
      options:[
        ...
        { text:'Explico as condições e, se fizer sentido, combinamos até o dia XX?', next:'proposta_resposta', effects:{empatia:+1,resolucao:0,tempo:+1,satisf:+4}, tag:'very_good' },
